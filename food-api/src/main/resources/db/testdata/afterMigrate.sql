...
insert into tb_permissao (id_permissao, nm_permissao, ds_permissao) values (1, 'EDITAR_COZINHAS', 'Permite editar cozinhas');
...
insert into tb_permissao (id_permissao, nm_permissao, ds_permissao) values (10, 'GERAR_RELATORIOS', 'Permite gerar relatórios');
...
(6, 'Débora Mendonça', 'ist.vepilef.serpa+teste1@gmail.com', '$2a$12$iDLsh5J.zz2RskgJc4RH9uWORIGaSUczp6LWK6n3NrBCCPJgCvOOK', utc_timestamp),
(7, 'Carlos Vinícios', 'ist.vepilef.serpa+teste2@gmail.com', '$2a$12$iDLsh5J.zz2RskgJc4RH9uWORIGaSUczp6LWK6n3NrBCCPJgCvOOK', utc_timestamp),
...
values (
  ...
  'READ,WRITE', 'authorization_code', 'http://aplicacao-cliente,http://localhost:3000,http://localhost:3000/pkce', null,
  null, null, null
);
